...
const MedalTime = () => {
 ...
 <div className="header-banner">
  ...
  <p>
    В этом разделе вы узнаете, как установить точное время сброса медали на вашем сервере. 
    ...
    который автоматически преобразует дату и время в нужный формат.
        ...
        <h2>⚔️ Время Медали указывается в секундах</h2>
